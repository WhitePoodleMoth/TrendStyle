 ...
 */
public class AdminOrderScreen extends javax.swing.JFrame {
    int ID = 0;
    
    /**
     * Creates new form AdminOrderScreen
     */
    public AdminOrderScreen(int _ID) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("TrendStyle - Admin Order");

        Panel.setBackground(new java.awt.Color(255, 255, 255));
        Panel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/media/adminOrder.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminOrderScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminOrderScreen(0).setVisible(true);
            }
        });
    }
