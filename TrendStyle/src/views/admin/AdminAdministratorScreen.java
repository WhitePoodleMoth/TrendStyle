...
public class AdminAdministratorScreen extends javax.swing.JFrame {
    ...
    public boolean updateTable() {
        DefaultTableModel tableModel = new DefaultTableModel(
                new Object[]{"ID", "Usuário", "CPF", "Nome", "Email", "Telefone"}, 0) {
        ...
        ArrayList<ArrayList<?>> categories = dbAccess.collectAdmins();
        ArrayList<String> ids = (ArrayList<String>) categories.get(0);
        ArrayList<String> usuarios = (ArrayList<String>) categories.get(1);
        ArrayList<String> cpfs = (ArrayList<String>) categories.get(2);
        ArrayList<String> nomes = (ArrayList<String>) categories.get(3);
        ArrayList<String> emails = (ArrayList<String>) categories.get(4);
        ArrayList<String> telefones = (ArrayList<String>) categories.get(5);
        ...
        for (int i = ids.size() - 1; i >= 0; i--) {
            ...
            tableModel.addRow(new Object[]{id, usuario, cpf, nome, email, telefone});
        }
        ...
        Table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 1) {
                    ...
                    adminID = Integer.parseInt(Table.getValueAt(linhaSelecionada, 0).toString());
     ...
     */
    public AdminAdministratorScreen(int _ID) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/media/adminAdmin.png"))); // NOI18N
    ...
    private void ButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRegisterActionPerformed
        AdminRegisterScreen page = new AdminRegisterScreen(this.ID);
        page.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAdministratorScreen(0).setVisible(true);
            }
        });
    }
