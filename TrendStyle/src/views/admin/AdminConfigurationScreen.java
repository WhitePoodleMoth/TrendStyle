...
public class AdminConfigurationScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("TrendStyle - Admin Configuration");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminConfigurationScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
